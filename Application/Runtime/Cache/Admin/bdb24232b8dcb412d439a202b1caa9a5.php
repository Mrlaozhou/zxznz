...
<div id="header-div">
    <div id="logo-div" style="bgcolor:#000000;">
        <img src='/Public/Admin/Images/eee.gif' alt="ECSHOP - power for e-commerce" />
    </div>
    <div id="submenu-div">
        <ul>
            <li><a href="<?php echo U('Home/Index/index');?>" target="_blank">查看官网</a></li>
            <li><a href="<?php echo U('showPerson');?>" target="main-frame">个人设置</a></li>
            <li style="border-right:none"><a href="javascript:window.parent.location.reload();">刷新</a></li>
        </ul>
        <div id="send_info">
            <a href="javascript:void(0)" target="main-frame" class="fix-submenu">清除缓存</a>
            <a href="<?php echo U('Login/logout');?>" onclick="return window.confirm('你确定要退出？');" target="_top" class="fix-submenu">退出</a>
        </div>
    </div>
</div>
<div id="menu-div">
