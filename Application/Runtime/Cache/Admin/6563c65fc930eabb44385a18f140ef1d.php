...
<div class="tab-div">
    ...
    <div id="tabbody-div">
        <form method="post" action="/index.php/Admin/Doctor/edit/id/1509.html" enctype="multipart/form-data" >
            <!-- 基本信息 -->
            <table class="tab_content" cellspacing="1" cellpadding="3" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <img style="width:50px;" src="/Public/Uploads/<?php echo $info['picture'];?>"><br />
