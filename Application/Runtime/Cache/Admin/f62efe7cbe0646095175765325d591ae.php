...
<div class="tab-div">
    ...
    <div id="tabbody-div">
	    <form method="post" action="/index.php/Admin/Hospital/edit/id/340.html" enctype="multipart/form-data" >
	    	<!-- 基本信息 -->
	        <table class="tab_content" cellspacing="1" cellpadding="3" width="100%">
	            ...
	            <tr>
		            <td></td>
	                <td>
	                	<img src="/Public/Uploads/<?php echo $info['logo'];?>" width='60' />
	                </td>
	            </tr>
	            <tr>
	            	...
	            	<td>
	            		<ul style="list-style:none;">
			            	...
			            	<li style="margin:10px 5px 10px 5px;float:left;">
			            		<img src="/Public/Uploads/<?php echo $v['path'];?>" width='60'>
