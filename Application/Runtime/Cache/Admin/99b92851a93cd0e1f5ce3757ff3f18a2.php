...
<div class="tab-div">
    ...
    <div id="tabbody-div">
	    <form method="post" action="/index.php/admin/active/edit/id/7.html" enctype="multipart/form-data" >
	    	<!-- 基本信息 -->
	        <table class="tab_content" cellspacing="1" cellpadding="3" width="100%">
	            <tr>
	                <td class="label">活动标题</td>
	                <td>
	                    <input type="text" name="title" size="60" maxlength="60" value="<?php echo $info['title'];?>" />
	            ...
	            <tr>
	                ...
	                <td>
						<input type="text" name="action" size="20" value="<?php echo $info['action'];?>"/>
						<span class="require-field">*</span>
	                    <br /><br />
	                </td>
	            </tr>
	            ...
	            <tr>
	                ...
	                <td>
						<input type="file" name="imgRar" size="40" />
						<span class="require-field">*</span>
	                    <br /><br />
	                </td>
	            </tr>
	            <tr>
	                ...
	                <td>
						<input type="text" name="location" size="40"  value="<?php echo $info['location'];?>"/>
						<span class="require-field">*</span>
	                    <br /><br />
	                </td>
	            </tr>
	        	<tr>
	                <td class="label">活动医院</td>
	                <td>
						<input type="text" name="hospital" size="40" value="<?php echo $info['hospital'];?>" />
						<span class="require-field">*</span>
	                    <br /><br />
	                </td>
	            </tr>
	            <tr>
	                ...
	                <td>
	                	<img style="width:110px;height:60px;" src="/Public/Uploads/<?php echo $info['pic'];?>"><br /><br />
	            ...
	            <!-- <tr>
	                ...
	                <td>
	                    <input type="text" name="object" size='30'  value="<?php echo $info['object'];?>"/>
	            ...
	            <tr>
	                ...
	                <td>
	                    ...
	                    <input class="Wdate" type="text" name="start_time" onClick="WdatePicker()" value="<?php echo date('Y-m-d',$info['start_time']);?>">
	                     — 
	                    <input class="Wdate" type="text" name="end_time" onClick="WdatePicker()" value="<?php echo date('Y-m-d',$info['end_time']);?>">
	                    <span class="require-field">*</span>          
	                    <br /><br />
	                </td>
	            </tr>
	            <tr>
	                ...
	                <td>
	                    <input type="radio" name="is_top" value="1" <?php if($info['is_top'] == 1){echo "checked='checked'";}?> /> 是
	            ...
	            <tr>
	                ...
	                <td>
	                    <input type="radio" name="status" value="1"  <?php if($info['status'] == 1){echo "checked='checked'";}?>/> 正在进行
	                    <input type="radio" name="status" value="0"  <?php if($info['status'] == 0){echo "checked='checked'";}?>/> 即将开始
	                    <br /><br />
	                </td>
	            </tr>
	            <tr>
	            ...
	            <tr>
	                ...
	                <td>
	                    <textarea style="width:40%;" name="intro"><?php echo htmlspecialchars_decode($info['intro']);?></textarea>
	                    <br /><br />
	                </td>
	            </tr>
	        </table>
