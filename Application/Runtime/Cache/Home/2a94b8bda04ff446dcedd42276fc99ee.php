...
<div class="huodong">
    ...
    <div style="width:100%;height:545px;">
        <a target="_blank" href="<?php echo U('Active/threey?navNum=6');?>"><img style="width:100%;height:545px;" src="/Public/Home/images/detial-1.jpg"></a>
    </div>
    <div class="hd_con">
    	<li>
        ...
        <li class="hdr">
            ...
            <div style="padding:20px;font-size:16px;">
                <p style="color:#fe0072;margin-top:0px;">
                    <span style="padding:0 10px;"><img src="/Public/Home/images/wenzibiao.jpg"></span>2/14 [ 武汉地区 活动专场 ]
                </p>
                <p style="">
                    <span style="padding:0 10px;"><img src="/Public/Home/images/wenzibiao.jpg"></span>3/10 ~ 3/12 [ 北京地区 活动专场 ]
                </p>
                <p style="">
                    <span style="padding:0 10px;"><img src="/Public/Home/images/wenzibiao.jpg"></span>4月 [ 上海地区 活动专场 ]
                </p>
                <p style="">
                    <span style="padding:0 10px;"><img src="/Public/Home/images/wenzibiao.jpg"></span>5月 [ 广州地区 活动专场 ]
                </p>

                <p style="">
                    <span style="padding:0 10px;"><img src="/Public/Home/images/wenzibiao.jpg"></span>6月 [ 广州地区 活动专场 ]
                </p>
                <p style="">
                    <span style="padding:0 10px;"><img src="/Public/Home/images/wenzibiao.jpg"></span>7月 [ 广州地区 活动专场 ]
                </p>
                <p style="">
                    <span style="padding:0 10px;"><img src="/Public/Home/images/wenzibiao.jpg"></span>8月 [ 广州地区 活动专场 ]
                </p>
                <p style="color:#fe0072;">
...
<div class="publish">
    ...
    <ul class="publish-item">
        ...
        <li class="floatR" style="margin-bottom:20px;">
            ...
            <!--
                <p style="color:#fe0072;margin-top:10px;">
                    <span style="padding:0 10px;"><img src="/Public/Home/images/wenzibiao.jpg"></span>斑点妹诱因盘点你属哪种？
                </p>
                <p style="">
                    <span style="padding:0 10px;"><img src="/Public/Home/images/wenzibiao.jpg"></span>激光祛斑 让皮肤光洁无瑕
                </p>
                <p style="">
                    <span style="padding:0 10px;"><img src="/Public/Home/images/wenzibiao.jpg"></span>祛斑先识别 雀斑和黄褐斑大有不同
                </p>
                <p style="">
                    <span style="padding:0 10px;"><img src="/Public/Home/images/wenzibiao.jpg"></span>微晶磨削祛斑需要多少次治疗？
                </p>
                <p style="">
                    <span style="padding:0 10px;"><img src="/Public/Home/images/wenzibiao.jpg"></span>
                    E光祛斑美肤原理以及术后护理
                </p>
                <p style="color:#fe0072;">
                    <span style="padding:0 10px;"><img src="/Public/Home/images/wenzibiao.jpg"></span>
                            ...
                            <?php foreach($Dinfo as $k => $v):?>
                                <li class="js_slide" style="position: relative;">
                                    <a target="_blank" href="<?php echo U('Doctor/detial?navNum=2&id='.$v['id'])?>">
                                        <img style="width:240px;" src="/Public/Uploads/<?php echo $v['picture'];?>">
                                    </a>
                                    <p style="width:240px;height:40px;background: black;position: absolute;bottom:0;left:5px;opacity: .6;text-align: center;line-height: 40px;">
